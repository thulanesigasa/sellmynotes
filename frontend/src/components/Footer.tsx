      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="#" className="text-sm text-gray-500 hover:text-gray-900">FAQ</Link></li>
              <li><Link href="#" className="text-sm text-gray-500 hover:text-gray-900">About Us</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="#" className="text-sm text-gray-500 hover:text-gray-900">Shipping & Delivery</Link></li>
              <li><Link href="#" className="text-sm text-gray-500 hover:text-gray-900">Refund Policy</Link></li>
            </ul>
          </div>
        </div>
